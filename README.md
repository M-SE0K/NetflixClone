...
| v3.0.0 | - | 모바일 UX 개선, 애니메이션 최적화 |

### v3.0.0 변경사항

**🎨 모바일 로그인/회원가입 UX 개선**
- 폼 전환 애니메이션: 좌우 슬라이드 → **위-아래 교차** 방식으로 변경
- 레이아웃 최적화: 스크롤 제거, **한 화면에 모든 요소 표시**
- 요소 크기 조정: 컴팩트한 모바일 UI 제공

**✨ 애니메이션 개선**
- 전환 시간: **1초**로 통일 (기존 0.45초)
- Easing: Material Design 표준 easing 적용 `[0.4, 0, 0.2, 1]`
- 더 부드럽고 자연스러운 전환 효과

**📱 모바일 최적화 상세**
| 요소 | v2.0.0 | v3.0.0 |
|------|--------|--------|
| SlidePanel 높이 | 200px | 140px |
| 폼 패딩 | 32px | 16px |
| 전환 방향 | 좌우 | 위-아래 |
| 전환 시간 | 0.45s | 1s |
| InfoBox | 표시 | 숨김 |
